...
/********* Food Class	***********/
Food::Food(long SKU, std::string description, float price, int quantity,
		std::string brand, std::string category, std::string exirationDate) : Item(SKU, description, price, quantity, brand, category) {
...
/********* Clothing Class	***********/
Clothing::Clothing(long SKU, std::string description, float price, int quantity,
		std::string brand, std::string category, std::string size,
		std::string color) : Item(SKU, description, price, quantity, brand, category) {
	this->color = color;
	this->size = size;
}
...
/********* Electronic Class	***********/
Electronic::Electronic(long SKU, std::string description, float price,
		int quantity, std::string brand, std::string category) : Item(SKU, description, price, quantity, brand, category) {
}

Furniture::Furniture(long SKU, std::string description, float price,
		int quantity, std::string brand, std::string category) : Item(SKU, description, price, quantity, brand, category) {
}
