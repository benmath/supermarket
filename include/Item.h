...
public:
	Food(long SKU, std::string description, float price, int quantity, std::string brand, std::string category, std::string exirationDate);
...
public:
	Clothing(long SKU, std::string description, float price, int quantity, std::string brand, std::string category, std::string size, std::string color);
...
public:
	Electronic(long SKU, std::string description, float price, int quantity, std::string brand, std::string category);
...
public:
	Furniture(long SKU, std::string description, float price, int quantity, std::string brand, std::string category);
